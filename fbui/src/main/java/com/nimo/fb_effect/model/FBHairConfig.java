...
public class FBHairConfig {
    ...
    public static class FBHair {
        ...
        public static final FBHair NO_HAIR = new FBHair("", "", "",0,"","", FBDownloadState.COMPLETE_DOWNLOAD);
        public static final FBHair NEW_HAIR = new FBHair("", "", "", 0,"","",FBDownloadState.COMPLETE_DOWNLOAD);
...
//      return FBEffect.shareInstance().getARItemUrlBy(FBItemEnum.FBItemMask.getValue()) + icon;
        ...
        public void downloaded() {
            ...
            for (FBHair hair : tiHairConfig.getHairs()) {
